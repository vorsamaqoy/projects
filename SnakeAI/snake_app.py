...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def save_best_agent(self):
        best_agent = self.population.fittest_individual
    ...
    def next_generation(self):
        ...
        # Calcola il fitness degli individui
        for individual in self.population.individuals:
            individual.calculate_fitness()
        
        current_best_fitness = self.population.fittest_individual.fitness
        print("Migliore fitness attuale:", current_best_fitness)

        # Salva il miglior agente se il suo fitness è superiore a quello precedente
        if current_best_fitness > self.best_fitness:
            self.best_fitness = current_best_fitness
            self.save_best_agent()  # Salva il miglior agente
